# DSP MATLAB — Full Codebook (Chapter-wise, Serial Order)

Every problem from your `Full.docx`, in the exact order your lab manual presents them — Chapter 1 through Chapter 7, matching the problem list you gave (Chapter 4 excluded, since it isn't in your uploaded file). This is the **serial, book-order companion** to the operation-based *Lab Final Survival Guide* — use that one to study by topic, use this one to look up or double-check a specific numbered program exactly as your book has it.

Only cleanup applied: consistent formatting and a `clc; clear; close all;` header note where needed. The logic, variable names, and comments are exactly as extracted from your document.
...
- [1.1 — Generation of Elementary Signals in Discrete-time](#11-generation-of-elementary-signals-in-discrete-time)
- [1.2 — Generation of a Discrete-time Exponential Sequence](#12-generation-of-a-discrete-time-exponential-sequence)
- [1.3 — Multiplication of Discrete-time Signals](#13-multiplication-of-discrete-time-signals)
- [1.4 — Even and Odd Components of the Sequence y(n)=u(n)-u(n-10)](#14-even-and-odd-components-of-the-sequence-y-n-u-n-u-n-10)
- [1.5 — Generation of the Composite Sequence x(n)=u(n+3)+5u(n-15)+4u(n+10)](#15-generation-of-the-composite-sequence-x-n-u-n-3-5u-n-15-4u-n-10)
- [1.6 — Generation of Swept-frequency Sinusoidal Signal](#16-generation-of-swept-frequency-sinusoidal-signal)
- [1.7 — Checking the Time-invariance Property](#17-checking-the-time-invariance-property)
- [1.8 — Computation of Impulse Response](#18-computation-of-impulse-response)
- [1.9 — Checking the Linearity of a System](#19-checking-the-linearity-of-a-system)
- [1.10 — Testing the Stability of a System](#110-testing-the-stability-of-a-system)

**Chapter 2 — Convolution and Correlation**
- [2.1 — Convolution of Two Sequences](#21-convolution-of-two-sequences)
- [2.2 — Linear Convolution via Circular Convolution](#22-linear-convolution-via-circular-convolution)
- [2.3 — Linear Convolution Using DFT](#23-linear-convolution-using-dft)
- [2.4 — Circular Convolution Using DFT Based Approach](#24-circular-convolution-using-dft-based-approach)
- [2.5 — Computation of Correlation](#25-computation-of-correlation)

**Chapter 3 — Z-Transform and Related Topics**
- [3.1 — Z-transform and Inverse Z-transform of Given Signals](#31-z-transform-and-inverse-z-transform-of-given-signals)
- [3.2 — Finding the Residues of Z^3/[(z-0.5)(z-0.75)(z-1)]](#32-finding-the-residues-of-z-3-z-0-5-z-0-75-z-1)
- [3.3 — Inverse Z-transform by the Polynomial Division Method](#33-inverse-z-transform-by-the-polynomial-division-method)
- [3.4 — Inverse Z-transform for the Cascaded Form Using Polynomial Division Method](#34-inverse-z-transform-for-the-cascaded-form-using-polynomial-division-method)
- [3.5 — Pole-zero Plot of a Butterworth Band Pass Filter](#35-pole-zero-plot-of-a-butterworth-band-pass-filter)
- [3.6 — Convolution Using Z-transform](#36-convolution-using-z-transform)

**Chapter 5 — Fourier Transform and DTFT**
- [5.1 — Fourier Transform and Inverse Fourier Transform of a Given Sequence](#51-fourier-transform-and-inverse-fourier-transform-of-a-given-sequence)
- [5.2 — Fourier Transform of a Signal u(t+0.5)-u(t-0.5)](#52-fourier-transform-of-a-signal-u-t-0-5-u-t-0-5)
- [5.3 — Evaluation and Plotting of DTFT of the Transfer Function](#53-evaluation-and-plotting-of-dtft-of-the-transfer-function)
- [5.4 — Time Shifting Property of DTFT](#54-time-shifting-property-of-dtft)
- [5.5 — Frequency Shifting Property of DTFT](#55-frequency-shifting-property-of-dtft)
- [5.6 — Time Convolution Property of DTFT](#56-time-convolution-property-of-dtft)
- [5.7 — Time Reversal Property of DTFT](#57-time-reversal-property-of-dtft)
- [5.8 — Frequency Response of the Given System](#58-frequency-response-of-the-given-system)
- [5.9 — Periodicity Property of DTFT](#59-periodicity-property-of-dtft)

**Chapter 6 — Fourier Series and DFT**
- [6.1 — Fourier Series Representation of a Train of Pulses](#61-fourier-series-representation-of-a-train-of-pulses)
- [6.2 — Fourier Series Representation of a Full Wave Rectified Wave](#62-fourier-series-representation-of-a-full-wave-rectified-wave)
- [6.3 — Direct Computation of Discrete Fourier Transform (Matrix Formulation)](#63-direct-computation-of-discrete-fourier-transform-matrix-formulation)
- [6.4 — Linear Convolution Using DFT](#64-linear-convolution-using-dft)
- [6.5 — Circular Convolution Using DFT](#65-circular-convolution-using-dft)
- [6.6 — Relation Between DFTs of the Periodic Even and Odd Parts of a Real Sequence](#66-relation-between-dfts-of-the-periodic-even-and-odd-parts-of-a-real-sequence)
- [6.7 — Parseval's Relation of DFT](#67-parseval-s-relation-of-dft)
- [6.8 — Circular Time Shifting Property of DFT](#68-circular-time-shifting-property-of-dft)
- [6.9 — Gibbs Phenomenon](#69-gibbs-phenomenon)

**Chapter 7 — FFT**
- [7.1 — Calculation of the DFT of a Given Sequence Using FFT](#71-calculation-of-the-dft-of-a-given-sequence-using-fft)
- [7.2 — Linear Convolution Using FFT](#72-linear-convolution-using-fft)
- [7.3 — Circular Convolution Using FFT](#73-circular-convolution-using-fft)
- [7.4 — Plotting of DFT of Sinusoidal Wave](#74-plotting-of-dft-of-sinusoidal-wave)
...
```matlab
1. MATLAB Code: Computation of Impulse Response
