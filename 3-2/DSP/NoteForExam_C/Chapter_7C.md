...
$$
\boxed{ x(n) = \frac1N \left[ \operatorname{DFT}\{X^*(k)\} \right]^*. }
$$
...
$$
\boxed{ x(n)= \frac1N \left[ \operatorname{FFT}\{X^*(k)\} \right]^*. }
$$
...
$$
\boxed{ x(n)= \frac1N [\operatorname{DFT}\{X^*(k)\}]^*. }
$$
...
$$
\boxed{ x(n)= \frac1N [\operatorname{FFT}\{X^*(k)\}]^*. }
$$
...
$$
\boxed{ X^*\rightarrow FFT\rightarrow(\cdot)^*\rightarrow1/N. }
$$
