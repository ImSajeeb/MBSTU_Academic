...
$$
\boxed{ h(n)=h_1(n)*[h_2(n)+h_3(n)] }
$$

and by distributive property,

$$
\boxed{ h(n)=h_1(n)*h_2(n)+h_1(n)*h_3(n) }
$$
...
$$
\boxed{ x(n)*h(n) = x_p(n)\oplus_N h_p(n) }
$$
...
$$
\boxed{ y=x*h \rightarrow \text{solve sequentially for unknown samples} }
$$
...
$$
\boxed{ [x*h_1]*h_2=x*[h_1*h_2] }
$$

$$
\boxed{ x*(h_1+h_2)=x*h_1+x*h_2 }
$$
