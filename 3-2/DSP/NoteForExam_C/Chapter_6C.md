...
$$
\boxed{
\text{finite-duration discrete-time sequence}
\longrightarrow
\text{finite-length discrete-frequency sequence}
}
$$
...
\boxed{
x(n)
\ \xleftrightarrow[\text{IDFT}]{\text{DFT}}\ 
X(k)
}
$$
...
$$
\boxed{
\text{periodic convolution in time}
\longleftrightarrow
...
$$
\begin{aligned}
X(z)\bigg|_{z=e^{j2\pi k/N}}
&=
\sum_{n=0}^{N-1}
x(n)
\left(e^{j2\pi k/N}\right)^{-n}
\\
&=
\sum_{n=0}^{N-1}
x(n)e^{-j2\pi nk/N}
...
$$
\boxed{
\delta(n)\xleftrightarrow{\text{DFT}}1
}
$$
...
$$
\boxed{
\text{circular convolution in time}
\longleftrightarrow
\text{multiplication in frequency}.
}
$$
...
X_1(k)X_2(k)
=
\text{DFT}\{x_1(n)\circledast x_2(n)\}.
}
$$
...
\text{DFT property}
\Longleftrightarrow
\text{corresponding IDFT property}.
}
$$
...
$$
\boxed{
\text{zero-padding prevents time aliasing.}
}
$$
...
$$
\boxed{
\text{DFT}=\text{samples of DTFT at }2\pi k/N.
}
$$
...
$$
\boxed{
\text{DFT multiplication}\Rightarrow\text{circular convolution}
}
$$
...
$$
\boxed{
\text{OLA: add overlaps}
}
$$

$$
\boxed{
\text{OLS: discard corrupted overlaps}
}
$$
...
$$
\boxed{
\text{adding overlapping output samples}.
}
$$
...
$$
\boxed{
\text{discarding the first }N-1\text{ samples of each circular-convolution output}.
}
$$
...
$$
\boxed{
\text{prepend zeros}\rightarrow
\text{overlap blocks}\rightarrow
\text{circular convolution}\rightarrow
\text{discard first }N-1\rightarrow
\text{concatenate}.
}
$$
...
\boxed{
X(N-k)=X^*(k)
\quad\text{for real }x(n)
}
$$

$$
\boxed{
\text{DFT}\{x\circledast h\}=XH
}
$$
...
$$
\boxed{
\text{OLS: discard first }N-1
}
$$

$$
\boxed{
\text{DFT direct}\sim O(N^2)
}
$$

$$
\boxed{
\text{FFT}\sim O(N\log_2N)
}
$$
