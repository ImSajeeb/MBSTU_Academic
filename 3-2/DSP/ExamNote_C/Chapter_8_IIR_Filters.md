...
$$
\boxed{ \text{Digital specifications} \rightarrow \text{analog prototype} \rightarrow \text{analog-to-digital transformation} \rightarrow H(z) }
$$
...
$$
\boxed{ H_a(s) = \frac{Y(s)}{X(s)} = \frac{\displaystyle\sum_{k=0}^{M}b_k s^k} {\displaystyle\sum_{k=0}^{N}a_k s^k}. }
$$

Its impulse response is related to the Laplace transform by

$$
\boxed{ H_a(s)= \int_{-\infty}^{\infty} h_a(t)e^{-st}\,dt. }
$$
...
$$
\boxed{ \text{stable analog filter} \Rightarrow \text{poles in LHP}. }
$$
...
$$
\boxed{ \text{stable digital filter} \Rightarrow |p_i|<1. }
$$
...
$$
\boxed{ \text{LHP}\rightarrow\text{inside unit circle} }
$$
...
$$
\boxed{ \text{Given digital specifications} }
$$
...
$$
\boxed{ \text{Design equivalent analog filter }H_a(s) }
$$
...
$$
\boxed{ \text{causal + stable IIR} \not\Rightarrow \text{linear phase}. }
$$
...
$$
\boxed{ \left. \frac{dy(t)}{dt} \right|_{t=nT} \approx \frac{y(n)-y(n-1)}{T}. }
$$
...
$$
\boxed{ H(z)=\frac{1-z^{-1}}{T}. }
$$

Hence the mapping is

$$
\boxed{ s \longrightarrow \frac{1-z^{-1}}{T}. }
$$
...
$$
\boxed{ \frac{d^2y(t)}{dt^2} \approx \frac{ y(n)-2y(n-1)+y(n-2) }{T^2}. }
$$

Therefore,

$$
\boxed{ s^2 \longrightarrow \left( \frac{1-z^{-1}}{T} \right)^2. }
$$
...
$$
\boxed{ s^i \longrightarrow \left( \frac{1-z^{-1}}{T} \right)^i. }
$$

Therefore the analog transfer function is transformed as

$$
\boxed{ H(z) = H_a(s) \bigg|_{\displaystyle s=(1-z^{-1})/T }. }
$$
...
$$
\boxed{ \left. \frac{dy(t)}{dt} \right|_{t=nT} = \frac1T \sum_{k=1}^{N} a_k \left[ y(n-k+1)-y(n-k) \right]. }
$$
...
$$
\boxed{ H_a(s)=\frac{2}{s+3} }
$$

and using backward difference,

$$
\boxed{ s=\frac{1-z^{-1}}{T}. }
$$

Therefore,

$$
H(z) = \frac{2} {\dfrac{1-z^{-1}}{T}+3}.
$$
...
$$
H(z)= \frac{4} {\left(\dfrac{1-z^{-1}}{T}\right)^2+9}.
$$
...
$$
H(z) = \frac{3} {(1-z^{-1}+0.5)^2+16}.
$$

Therefore,

$$
\boxed{ H(z)= \frac{3} {2.25-3z^{-1}+z^{-2}+16}. }
$$
...
$$
\boxed{ H_a(s)= \sum_{i=1}^{N} \frac{A_i}{s-p_i}. }
$$

The analog impulse response is

$$
\boxed{ h_a(t)= \sum_{i=1}^{N} A_i e^{p_i t}u_a(t). }
$$
...
$$
\boxed{ h(n)= \sum_{i=1}^{N} A_i e^{p_i nT}u(n). }
$$

Taking the Z-transform:

$$
H(z) = \sum_{i=1}^{N} A_i \sum_{n=0}^{\infty} \left(e^{p_iT}z^{-1}\right)^n.
$$

Therefore,

$$
\boxed{ H(z) = \sum_{i=1}^{N} \frac{A_i} {1-e^{p_iT}z^{-1}}. }
$$

Thus the pole mapping is

$$
\boxed{ p_i \longrightarrow z_i=e^{p_iT}. }
$$
...
$$
e^{j(\Omega+2\pi k/T)T} = e^{j\Omega T}.
$$
...
$$
\boxed{ \text{higher frequencies impersonate lower frequencies}. }
$$

To reduce aliasing in impulse invariant design:

$$
\boxed{ T\downarrow \quad\Longleftrightarrow\quad f_s\uparrow. }
$$
...
$$
\boxed{ z=e^{-aT}e^{\pm jbT}. }
$$

Hence

$$
\boxed{ z=e^{-aT} \left[ \cos(bT)\pm j\sin(bT) \right]. }
$$
...
$$
e^{-1}=0.3678, \qquad e^{-3}=0.0497.
$$

Hence

$$
\boxed{ H(z)= \frac{1}{1-0.3678z^{-1}} - \frac{1}{1-0.0497z^{-1}}. }
$$

Combining,

$$
\boxed{ H(z)= \frac{-0.3181z^{-1}} {1-0.4175z^{-1}+0.0182z^{-2}}. }
$$

### (b) $T=0.5$ s

$$
e^{-0.5}=0.606, \qquad e^{-1.5}=0.223.
$$

Thus

$$
\boxed{ H(z)= \frac{1}{1-0.606z^{-1}} - \frac{1}{1-0.223z^{-1}}. }
$$
...
$$
\boxed{ H_a(s)= \frac{s+0.1}{(s+0.1)^2+9} }
$$
...
$$
\boxed{ H(z)= \frac{ e^{-0.1T} \left[ \cos(3T) - \text{appropriate phase-weighted term} \right] } { 1-2e^{-0.1T}\cos(3T)z^{-1} +e^{-0.2T}z^{-2} } }
$$
...
$$
\boxed{ H_a(s)= \frac{s+0.5}{(s+0.5)^2+4} }
$$
...
$$
\boxed{ T=\frac14=0.25\text{ s}. }
$$

Partial fractions:

$$
\frac{2}{s(s+2)} = \frac1s-\frac1{s+2}.
$$
...
$$
\boxed{ H(z)= \frac1{1-z^{-1}} - \frac1{1-0.606z^{-1}}. }
$$
...
$$
\boxed{ H_a(s)= \frac{b}{(s+a)^2+b^2}, }
$$

the impulse-invariant digital denominator is

$$
\boxed{ 1-2e^{-aT}\cos(bT)z^{-1} + e^{-2aT}z^{-2}. }
$$
...
$$
\boxed{ z= \frac{1+sT/2}{1-sT/2}. }
$$

To design the digital filter:

$$
\boxed{ H(z)= H_a(s) \bigg|_{\displaystyle s=\frac{2}{T}\frac{1-z^{-1}}{1+z^{-1}} }. }
$$
...
$$
\int_{(n-1)T}^{nT}f(t)\,dt \approx \frac{T}{2} [f(nT)+f((n-1)T)].
$$

This gives

$$
\boxed{ y(n)-y(n-1) + \frac{aT}{2}[y(n)+y(n-1)] = \frac{bT}{2}[x(n)+x(n-1)]. }
$$

Taking the Z-transform produces

$$
\boxed{ H(z) = \frac{ (bT/2)(1+z^{-1}) }{ (1+aT/2) + (-1+aT/2)z^{-1} }. }
$$
...
$$
\boxed{ j\Omega\text{-axis}\rightarrow\text{unit circle} }
$$

$$
\boxed{ \text{RHP}\rightarrow\text{outside unit circle}. }
$$
...
$$
\boxed{ \omega= 2\tan^{-1} \left( \frac{\Omega T}{2} \right). }
$$
...
$$
\boxed{ \text{bilinear transformation does not preserve linear phase}. }
$$
...
$$
\boxed{ \Omega_p= \frac{2}{T} \tan\left(\frac{\omega}{2}\right). }
$$
...
$$
\Omega_r = \frac{2}{T} \tan\left(\frac{\omega_r}{2}\right).
$$
...
$$
\boxed{ \Omega_r= \frac{2}{T}\tan\left(\frac{\pi}{4}\right) = \frac{2}{T}. }
$$
...
$$
\boxed{ H_a(s)= \frac{s+0.5}{(s+0.5)^2+16} }
$$
...
$$
\boxed{ \Omega_r= \frac{2}{T} \tan\left(\frac{\omega_r}{2}\right). }
$$
...
$$
\boxed{ A_1\le |H(\Omega)|\le1, \qquad 0\le\Omega\le\Omega_1 }
$$

and

$$
\boxed{ |H(\Omega)|\le A_2, \qquad \Omega\ge\Omega_2. }
$$
...
$$
\boxed{ \alpha_1=\frac1{A_1} }
$$

and

$$
\boxed{ \alpha_2=\frac1{A_2}. }
$$

When expressed in dB:

$$
\boxed{ k_1=20\log_{10}A_1 }
$$

$$
\boxed{ k_2=20\log_{10}A_2. }
$$
...
$$
\boxed{ k_1=20\log_{10}(1-p) }
$$

and

$$
\boxed{ k_2=20\log_{10}s. }
$$
...
$$
\boxed{ \text{maximally flat at the origin} }
$$

and

$$
\boxed{ \text{monotonically decreasing with frequency}. }
$$

The low-pass Butterworth magnitude-squared response is

$$
\boxed{ |H_a(j\Omega)|^2 = \frac{1} {1+\left(\dfrac{\Omega}{\Omega_c}\right)^{2N}}. }
$$
...
$$
\boxed{ |H_a(j\Omega_c)|=\frac1{\sqrt2}. }
$$

Therefore the cutoff is the

$$
\boxed{ 3\text{-dB point}. }
$$
...
$$
\boxed{ p_k= \Omega_c \left( \cos\theta_k +j\sin\theta_k \right) }
$$
...
$$
\boxed{ b_k= 2\sin \left( \frac{(2k-1)\pi}{2N} \right). }
$$
...
$$
\boxed{ H_a(s)= \frac{\Omega_c^N} {\displaystyle \prod_{k=1}^{N/2} \left[ s^2+b_k\Omega_c s+\Omega_c^2 \right] }. }
$$

For odd $N$,

$$
\boxed{ H_a(s)= \frac{\Omega_c^N} {(s+\Omega_c) \displaystyle \prod_{k=1}^{(N-1)/2} \left[ s^2+b_k\Omega_c s+\Omega_c^2 \right] }. }
$$
...
$$
\boxed{ \Omega_i= \frac2T \tan\left(\frac{\omega_i}{2}\right). }
$$

For impulse invariant:

$$
\boxed{ \Omega_i=\frac{\omega_i}{T}. }
$$
...
$$
A_1 \le \frac1{ \sqrt{ 1+(\Omega_1/\Omega_c)^{2N} } }
$$

and

$$
A_2 \ge \frac1{ \sqrt{ 1+(\Omega_2/\Omega_c)^{2N} } },
$$

the book obtains the order condition

$$
\boxed{ N \ge \frac{ \log \left[ \dfrac{1/A_2^2-1} {1/A_1^2-1} \right] } { 2\log(\Omega_2/\Omega_1) }. }
$$
...
$$
\boxed{ \Omega_c = \frac{\Omega_1} { \left[ 1/A_1^2-1 \right]^{1/(2N)} }. }
$$

From the stopband specification,

$$
\boxed{ \Omega_c = \frac{\Omega_2} { \left[ 1/A_2^2-1 \right]^{1/(2N)} }. }
$$
...
$$
\boxed{ 0.9\le |H|\le1, \qquad 0\le\omega\le2 }
$$

and

$$
\boxed{ |H|\le0.2, \qquad \omega\ge4 }
$$
...
$$
\Omega_1 = 2\tan(2/2) = 2\tan1
$$

and

$$
\Omega_2 = 2\tan(4/2) = 2\tan2.
$$

The textbook obtains the ratio

$$
\boxed{ \frac{\Omega_2}{\Omega_1}\approx2.414. }
$$
...
$$
\boxed{ H_a(s)= \frac{\Omega_c^3} {(s+\Omega_c) (s^2+b_1\Omega_c s+\Omega_c^2)} }
$$
...
$$
\boxed{ 0.8\le |H|\le1,\qquad0\le\omega\le0.2 }
$$

$$
\boxed{ |H|\le0.2,\qquad\omega\ge0.32 }
$$
...
$$
\boxed{ \frac{\Omega_2}{\Omega_1}=1.6. }
$$
...
$$
\boxed{ \Omega_c\approx0.675\text{ rad/s}. }
$$
...
$$
\boxed{ A_1=10^{-3/20}=0.707 }
$$

$$
\boxed{ A_2=10^{-20/20}=0.1. }
$$

Normalize:

$$
\omega_1 = 2\pi\frac{2000}{10000} = 0.4\pi
$$

and

$$
\omega_2 = 2\pi\frac{4000}{10000} = 0.8\pi.
$$

Using bilinear transformation:

$$
\boxed{ \Omega_1=2f_s\tan(\omega_1/2) }
$$

$$
\boxed{ \Omega_2=2f_s\tan(\omega_2/2). }
$$

The book obtains

$$
\boxed{ \frac{\Omega_2}{\Omega_1}=4.236 }
$$
...
$$
\boxed{ \Omega= 2f_s\tan\left(\frac{\omega}{2}\right). }
$$

The textbook obtains approximately

$$
\boxed{ \Omega_1=2513.102\text{ rad/s} }
$$

and

$$
\boxed{ \Omega_2=15506.08\text{ rad/s}. }
$$

Thus

$$
\boxed{ \frac{\Omega_2}{\Omega_1}\approx6.1703. }
$$
...
$$
\boxed{ A_1=10^{-1/20}=0.8912 }
$$

$$
\boxed{ A_2=10^{-40/20}=0.01. }
$$
...
$$
\boxed{ \Omega_1\approx27706.49\text{ rad/s} }
$$

and

$$
\boxed{ \Omega_2\approx83100.52\text{ rad/s}. }
$$

Thus,

$$
\boxed{ \frac{\Omega_2}{\Omega_1}\approx2.9957. }
$$
...
$$
\boxed{ A_1=10^{-0.5/20}=0.9446 }
$$

$$
\boxed{ A_2=10^{-30/20}=0.0316. }
$$

After bilinear prewarping, the textbook obtains approximately

$$
\boxed{ \frac{\Omega_2}{\Omega_1}\approx1.8944 }
$$
...
$$
f_p=0.10\text{ Hz}, \qquad A_p=0.5\text{ dB}
$$

$$
f_s=0.15\text{ Hz}, \qquad A_s=15\text{ dB}
$$
...
$$
\boxed{ \frac{\Omega_2}{\Omega_1}=1.57 }
$$
...
$$
\boxed{ \text{equiripple passband, monotonic stopband} }
$$

### Type-2 Chebyshev

$$
\boxed{ \text{monotonic passband, equiripple stopband} }
$$

Type-2 is also called

$$
\boxed{ \text{inverse Chebyshev}. }
$$
...
$$
\boxed{ |H_a(j\Omega)|^2 = \frac1{ 1+\epsilon^2 C_N^2 \left( \frac{\Omega}{\Omega_c} \right) }. }
$$
...
$$
\boxed{ C_N(x)= \cos(N\cos^{-1}x), \qquad |x|\le1. }
$$
...
$$
\boxed{ \epsilon= \sqrt{ \frac1{A_1^2}-1 }. }
$$
...
$$
\boxed{ N \ge \frac{ \cosh^{-1} \left[ \sqrt{(1/A_2^2-1)/\epsilon^2} \right] } { \cosh^{-1}(\Omega_2/\Omega_1) }. }
$$
...
$$
\boxed{ H_a(s)= \frac{B_0} {\displaystyle \prod \left[ s^2+b_k\Omega_c s+c_k\Omega_c^2 \right] }. }
$$
...
$$
\epsilon, \qquad \theta_k, \qquad \sinh(\cdot), \qquad \cosh(\cdot).
$$
...
$$
\boxed{ s_n= -\sinh(y)\sin(x_n) + j\cosh(y)\cos(x_n) }
$$

with

$$
\boxed{ x_n= \frac{(2n-1)\pi}{2N}. }
$$
...
$$
\boxed{ 3\text{ dB ripple in passband}, \quad 0\le\omega\le0.2 }
$$

$$
\boxed{ 25\text{ dB attenuation in stopband}, \quad \omega\ge0.45. }
$$
...
$$
\boxed{ \epsilon\approx1. }
$$

The analog frequency ratio is

$$
\boxed{ \frac{\Omega_2}{\Omega_1} = \frac{\tan(0.45/2)} {\tan(0.2/2)} \approx2.628. }
$$
...
$$
\boxed{ 0.9\le|H|\le1, \qquad 0\le\omega\le0.3 }
$$

and

$$
\boxed{ |H|\le0.15, \qquad \omega\ge0.5. }
$$

Thus

$$
A_1=0.9, \qquad A_2=0.15.
$$
...
$$
\boxed{ \epsilon= \sqrt{\frac1{0.9^2}-1} \approx0.484. }
$$
...
$$
\boxed{ \frac{\Omega_2}{\Omega_1}=1.962. }
$$
...
$$
\boxed{ \text{maximally flat passband} }
$$

and

$$
\boxed{ \text{equiripple stopband}. }
$$
...
$$
\boxed{ C_N(x)= \cos(N\cos^{-1}x),\quad |x|\le1 }
$$

and

$$
\boxed{ C_N(x)= \cosh(N\cosh^{-1}x),\quad |x|>1. }
$$
...
$$
\boxed{ \text{minimum transition bandwidth} }
$$
...
$$
\boxed{ \text{Analog frequency transformation} }
$$

and

$$
\boxed{ \text{Digital frequency transformation}. }
$$
...
The prototype cutoff $\Omega_c$ is changed to a new cutoff $\Omega_c^\ast $.

The transformation is of the form

$$
\boxed{ s\rightarrow \frac{\Omega_c}{\Omega_c^\ast }s. }
$$
...
$$
\boxed{ H_{HP}(s) = H_p \left( \frac{\Omega_c\Omega_c^\ast }{s} \right). }
$$
...
$$
\boxed{ s \rightarrow \frac{s^2+\Omega_0^2}{Bs}. }
$$

Equivalently,

$$
\boxed{ s \rightarrow \frac{ s^2+\Omega_1\Omega_2 }{ (\Omega_2-\Omega_1)s }. }
$$
...
$$
\boxed{ s \rightarrow \frac{Bs}{s^2+\Omega_0^2}. }
$$

Equivalently,

$$
\boxed{ s \rightarrow \frac{ (\Omega_2-\Omega_1)s }{ s^2+\Omega_1\Omega_2 }. }
$$
...
$$
\boxed{ B=\frac{3}{12}=0.25. }
$$

The low-pass-to-band-pass transformation is

$$
\boxed{ s\rightarrow \frac{s^2+\Omega_0^2}{Bs} = \frac{s^2+9}{0.25s}. }
$$
...
For a desired high-pass cutoff $\Omega_c^\ast $, use
...
$$
\boxed{ \text{unit circle}\rightarrow\text{unit circle} }
$$
...
$$
\boxed{ s= \frac2T \frac{1-z^{-1}}{1+z^{-1}}. }
$$
...
$$
\boxed{ |H_a(j\Omega)|^2 = \frac1{ 1+(\Omega/\Omega_c)^{2N} }. }
$$

Order:

$$
\boxed{ N \ge \frac{ \log \left[ (1/A_2^2-1)/(1/A_1^2-1) \right] }{ 2\log(\Omega_2/\Omega_1) }. }
$$

Cutoff:

$$
\boxed{ \Omega_c = \frac{\Omega_1} {(1/A_1^2-1)^{1/(2N)}}. }
$$
...
$$
\boxed{ |H_a(j\Omega)|^2 = \frac1{ 1+\epsilon^2 C_N^2(\Omega/\Omega_c) }. }
$$
...
$$
\boxed{ \text{smoothest magnitude response} }
$$

### Chebyshev-I

$$
\boxed{ \text{ripple in passband} }
$$

### Inverse Chebyshev

$$
\boxed{ \text{ripple in stopband} }
$$

### Elliptic

$$
\boxed{ \text{ripple in both} }
$$
...
$$
\boxed{ \begin{array}{c|c} \text{Impulse invariant}&\text{Bilinear}\\ \hline \text{Many-to-one}&\text{One-to-one}\\ \text{Aliasing}&\text{No aliasing}\\ \omega=\Omega T& \Omega=\frac2T\tan(\omega/2)\\ \text{Linear frequency mapping}&\text{Nonlinear mapping}\\ \text{Needs band-limited analog filter}&\text{No such requirement} \end{array} }
$$

## Butterworth vs Chebyshev-I

$$
\boxed{ \begin{array}{c|c} \text{Butterworth}&\text{Chebyshev-I}\\ \hline \text{Maximally flat}&\text{Equiripple passband}\\ \text{Monotonic}&\text{Ripple}\\ \text{Poles on circle}&\text{Poles on ellipse}\\ \text{1st/2nd-order smooth response}&\text{Sharper transition} \end{array} }
$$
...
$$
\boxed{ \Omega_i= \frac2T\tan(\omega_i/2). }
$$
...
$$
\boxed{ s\rightarrow\frac{1-z^{-1}}{T} }
$$
...
$$
\boxed{ \text{LHP}\rightarrow|z|<1 }
$$

$$
\boxed{ j\Omega\text{-axis}\rightarrow|z|=1 }
$$

$$
\boxed{ \text{RHP}\rightarrow|z|>1 }
$$
...
$$
\boxed{ |H|^2= \frac1{1+(\Omega/\Omega_c)^{2N}} }
$$

$$
\boxed{ |H(\Omega_c)|=\frac1{\sqrt2} }
$$
...
$$
\boxed{ \epsilon= \sqrt{1/A_1^2-1} }
$$

$$
\boxed{ |H|^2= \frac1{1+\epsilon^2C_N^2(\Omega/\Omega_c)} }
$$
...
$$
\boxed{ \text{IIR} = \text{Infinite response} = \text{recursive} }
$$

$$
\boxed{ \text{FIR} = \text{Finite response} = \text{non-recursive} }
$$

$$
\boxed{ \text{Impulse invariant} = \text{sample impulse response} }
$$
...
$$
\boxed{ \text{Bilinear} = \text{one-to-one} }
$$
...
$$
\boxed{ \text{prewarping fixes magnitude-frequency placement} }
$$

$$
\boxed{ \text{Butterworth} = \text{maximally flat} }
$$

$$
\boxed{ \text{Chebyshev-I} = \text{passband ripple} }
$$

$$
\boxed{ \text{Inverse Chebyshev} = \text{stopband ripple} }
$$

$$
\boxed{ \text{Elliptic} = \text{ripple in both} }
$$
...
$$
\boxed{ \text{Specifications} \rightarrow \text{frequency conversion} \rightarrow \text{order} \rightarrow \text{cutoff} \rightarrow H_a(s) \rightarrow H(z). }
$$
