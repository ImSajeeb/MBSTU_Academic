...
$$
x(n)\ast h(n) \quad\longleftrightarrow\quad X(e^{j\omega})H(e^{j\omega})
$$
...
$$
\boxed{ x(n)\ \xleftrightarrow{\mathcal F}\ X(e^{j\omega}) }
$$
...
$$
\boxed{ \sum_{n=-\infty}^{\infty}|x(n)|<\infty }
$$
...
$$
X(z) = \sum_{n=-\infty}^{\infty} x(n)(re^{j\omega})^{-n}
$$
...
$$
\boxed{ \delta(n)\xleftrightarrow{\mathcal F}1 }
$$
...
$$
X(e^{j\omega}) = 1+e^{-j\omega}+e^{-j2\omega}+\cdots
$$

so

$$
\boxed{ X(e^{j\omega}) = \frac{1}{1-e^{-j\omega}} }
$$
...
$$
X(e^{j\omega}) = e^{-j\omega m}.
$$

Hence

$$
\boxed{ \delta(n-m) \xleftrightarrow{\mathcal F} e^{-j\omega m} }
$$
...
$$
X(e^{j\omega}) = e^{-j\omega m} + e^{-j\omega(m+1)} + e^{-j\omega(m+2)} +\cdots
$$

Factor $e^{-j\omega m}$:

$$
X(e^{j\omega}) = e^{-j\omega m} \left[ 1+e^{-j\omega}+e^{-j2\omega}+\cdots \right].
$$

Therefore,

$$
\boxed{ X(e^{j\omega}) = \frac{e^{-j\omega m}} {1-e^{-j\omega}} }
$$
...
$$
X(e^{j\omega}) = -\sum_{k=1}^{\infty} a^{-k}e^{j\omega k}.
$$
...
$$
\delta(n+3) \longleftrightarrow e^{j3\omega}
$$
...
$$
X(e^{j\omega}) = e^{j3\omega}-e^{-j3\omega}.
$$
...
$$
\boxed{ X(e^{j\omega})=2j\sin(3\omega) }
$$
...
$$
X(e^{j\omega}) = \sum_{n=-3}^{2}e^{-j\omega n}.
$$
...
$$
X(e^{j\omega}) = x(0)+x(1)e^{-j\omega} +x(2)e^{-j2\omega} +x(3)e^{-j3\omega}.
$$

Hence

$$
\boxed{ X(e^{j\omega}) = 1-2e^{-j\omega} +2e^{-j2\omega} +3e^{-j3\omega} }
$$
...
$$
X(e^{j\omega}) = \frac14 \sum_{n=1}^{\infty} \left(\frac14\right)^n e^{-j\omega n}.
$$
...
$$
X(e^{j\omega}) = \sum_{n=-4}^{4}ne^{-j\omega n}.
$$

A useful way to simplify it is to pair positive and negative indices:

$$
ne^{-j\omega n}+(-n)e^{j\omega n} = n(e^{-j\omega n}-e^{j\omega n})
$$
...
$$
x(n)= \begin{cases} 1,&0\le n\le3,\\ 0,&\text{otherwise}, \end{cases}
$$
...
$$
\boxed{ X(e^{j\omega}) = e^{-j3\omega/2} \frac{\sin(2\omega)} {\sin(\omega/2)} }
$$
...
$$
x(n)= \begin{cases} a^n,&n\ge0,\\ a^{-n},&n<0. \end{cases}
$$

Then

$$
X(e^{j\omega}) = 1+\sum_{n=1}^{\infty}a^ne^{-j\omega n} +\sum_{n=1}^{\infty}a^ne^{j\omega n}.
$$

For $|a|<1$,

$$
X(e^{j\omega}) = 1+ \frac{ae^{-j\omega}}{1-ae^{-j\omega}} + \frac{ae^{j\omega}}{1-ae^{j\omega}}.
$$
...
$$
\sin(\omega_0n)u(n) = \frac{1}{2j} \left[ e^{j\omega_0n}u(n) - e^{-j\omega_0n}u(n) \right].
$$
...
$$
x(n)= \begin{cases} A,&-N\le n\le N,\\ 0,&\text{otherwise}. \end{cases}
$$

Then

$$
X(e^{j\omega}) = A\sum_{n=-N}^{N}e^{-j\omega n}.
$$

This is a finite geometric series. A standard symmetric form is

$$
\boxed{ X(e^{j\omega}) = A\frac{\sin\left[(2N+1)\omega/2\right]} {\sin(\omega/2)} }
$$
...
$$
X(e^{j\omega}) = e^{-j\omega}(1+\cos\omega).
$$

Use

$$
\cos\omega = \frac12(e^{j\omega}+e^{-j\omega}).
$$

Hence

$$
e^{-j\omega}(1+\cos\omega) = e^{-j\omega} + \frac12 + \frac12e^{-j2\omega}.
$$

Therefore the coefficients are

$$
x(0)=\frac12, \qquad x(1)=1, \qquad x(2)=\frac12.
$$

Thus

$$
\boxed{ x(n)=\left\{\frac12,\;1,\;\frac12\right\} }
$$
...
$$
x(n) = \frac{1}{2\pi} \left[ \int_{\omega_1}^{\omega_2} X(e^{j\omega})e^{j\omega n}\,d\omega + \int_{\omega_2}^{\omega_3} X(e^{j\omega})e^{j\omega n}\,d\omega +\cdots \right].
$$
...
$$
X(e^{j\omega}) = 2-e^{-j\omega}+3e^{-j3\omega}+4e^{-j4\omega},
$$
...
$$
x(0)=2, \quad x(1)=-1, \quad x(2)=0, \quad x(3)=3, \quad x(4)=4.
$$
...
$$
\boxed{ ax_1(n)+bx_2(n) \xleftrightarrow{\mathcal F} aX_1(e^{j\omega})+bX_2(e^{j\omega}) }
$$

### Proof

$$
\mathcal F\{ax_1(n)+bx_2(n)\} = \sum_n [ax_1(n)+bx_2(n)]e^{-j\omega n}
$$

$$
= a\sum_nx_1(n)e^{-j\omega n} + b\sum_nx_2(n)e^{-j\omega n}
$$
...
$$
\boxed{ x(n-m) \xleftrightarrow{\mathcal F} e^{-j\omega m}X(e^{j\omega}) }
$$

### Proof

$$
\mathcal F\{x(n-m)\} = \sum_nx(n-m)e^{-j\omega n}.
$$
...
$$
\sum_p x(p)e^{-j\omega(p+m)} = e^{-j\omega m} \sum_p x(p)e^{-j\omega p}.
$$

Hence

$$
\boxed{ \mathcal F\{x(n-m)\} = e^{-j\omega m}X(e^{j\omega}) }
$$
...
$$
|e^{-j\omega m}X(e^{j\omega})| = |X(e^{j\omega})|.
$$
...
$$
\boxed{ x(n)e^{j\omega_0n} \xleftrightarrow{\mathcal F} X(e^{j(\omega-\omega_0)}) }
$$

### Proof

$$
\mathcal F\{x(n)e^{j\omega_0n}\} = \sum_nx(n)e^{j\omega_0n}e^{-j\omega n}
$$
...
$$
\boxed{ nx(n) \xleftrightarrow{\mathcal F} j\frac{dX(e^{j\omega})}{d\omega} }
$$
...
$$
\frac{dX}{d\omega} = \sum_nx(n)(-jn)e^{-j\omega n}.
$$

Therefore,

$$
j\frac{dX}{d\omega} = \sum_nnx(n)e^{-j\omega n}.
$$

Hence

$$
\boxed{ \mathcal F\{nx(n)\} = j\frac{dX}{d\omega} }
$$
...
$$
\boxed{ x_1(n)\ast x_2(n) \xleftrightarrow{\mathcal F} X_1(e^{j\omega})X_2(e^{j\omega}) }
$$

Thus

$$
\boxed{ \mathcal F\{x_1\ast x_2\}=X_1X_2 }
$$
...
$$
\boxed{ \mathcal F\{x_1(n)x_2(n)\} = \frac{1}{2\pi} \int_{-\pi}^{\pi} X_1(e^{j\theta}) X_2(e^{j(\omega-\theta)}) \,d\theta }
$$
...
$$
\boxed{ \mathcal F\{R_{x_1x_2}(l)\} = X_1(e^{j\omega}) X_2(e^{-j\omega}) }
$$
...
$$
\boxed{ x(n)\cos(\omega_0n) \xleftrightarrow{\mathcal F} \frac12 \left[ X(e^{j(\omega-\omega_0)}) + X(e^{j(\omega+\omega_0)}) \right] }
$$
...
$$
x(n)\cos(\omega_0n) = \frac12x(n)e^{j\omega_0n} + \frac12x(n)e^{-j\omega_0n}.
$$
...
$$
\boxed{ \sum_{n=-\infty}^{\infty}|x(n)|^2 = \frac{1}{2\pi} \int_{-\pi}^{\pi} |X(e^{j\omega})|^2d\omega }
$$
...
$$
X(e^{j\omega}) = X_R(\omega)+jX_I(\omega).
$$
...
$$
X_R(\omega) = \sum_nx(n)\cos(\omega n)
$$

and

$$
X_I(\omega) = -\sum_nx(n)\sin(\omega n).
$$

For a **real sequence** $x(n)$:

$$
\boxed{ X_R(-\omega)=X_R(\omega) }
$$

so the real part is even, and

$$
\boxed{ X_I(-\omega)=-X_I(\omega) }
$$
...
$$
\boxed{ X(e^{j\omega}) = |X(e^{j\omega})|e^{j\theta(\omega)} }
$$
...
$$
|X(e^{j\omega})| = \sqrt{X_R^2(\omega)+X_I^2(\omega)}
$$

and

$$
\boxed{ \theta(\omega) = \tan^{-1} \left( \frac{X_I(\omega)}{X_R(\omega)} \right) }
$$
...
| $nx(n)$ | $j\,dX/d\omega$ |
| $x_1(n)\ast x_2(n)$ | $X_1X_2$ |
| $x_1(n)x_2(n)$ | $\frac1{2\pi}X_1\ast _{\rm periodic}X_2$ |
...
$$
x(n)e^{j\omega_0n} \leftrightarrow X(e^{j(\omega-\omega_0)}).
$$
...
$$
x_1(n)x_2(n) \leftrightarrow \frac1{2\pi} X_1\ast _{\rm periodic}X_2.
$$
...
$$
H(e^{j\omega}) = 1+ae^{-j\omega}+a^2e^{-j2\omega} +a^3e^{-j3\omega}+\cdots.
$$
...
$$
h(0)=1,\quad h(1)=a,\quad h(2)=a^2,\ldots
$$
...
$$
Y(e^{j\omega}) \longrightarrow \text{rewrite as known transforms}
$$

then

$$
Y(e^{j\omega}) \longrightarrow y(n).
$$
...
$$
X(e^{j\omega}) = 1+3e^{-j\omega} +2e^{-j2\omega} +e^{-j3\omega}.
$$

For the impulse response,

$$
H(e^{j\omega}) = 1+2e^{-j\omega} +e^{-j2\omega} -2e^{-j3\omega}.
$$

Multiply:

$$
Y(e^{j\omega}) = (1+3e^{-j\omega}+2e^{-j2\omega}+e^{-j3\omega}) (1+2e^{-j\omega}+e^{-j2\omega}-2e^{-j3\omega}).
$$

Collect equal powers of $e^{-j\omega}$:

$$
Y(e^{j\omega}) = 1+5e^{-j\omega} +9e^{-j2\omega} +6e^{-j3\omega} +2e^{-j4\omega} +3e^{-j5\omega} -2e^{-j6\omega}.
$$
...
$$
X_1(e^{j\omega}) = \frac1{1-\frac12e^{-j\omega}}
$$

and

$$
X_2(e^{j\omega}) = \frac1{1-\frac13e^{-j\omega}}.
$$

By the convolution property,

$$
\mathcal F\{x_1\ast x_2\} = X_1X_2.
$$

Therefore,

$$
Y(e^{j\omega}) = \frac1{ (1-\frac12e^{-j\omega}) (1-\frac13e^{-j\omega}) }.
$$

Use partial fractions:

$$
\frac1{ (1-\frac12z^{-1})(1-\frac13z^{-1}) } = \frac{A}{1-\frac12z^{-1}} + \frac{B}{1-\frac13z^{-1}}.
$$
...
$$
Y(e^{j\omega}) = \frac3{1-\frac12e^{-j\omega}} - \frac2{1-\frac13e^{-j\omega}}.
$$

Taking inverse DTFT,

$$
\boxed{ y(n) = 3\left(\frac12\right)^n u(n) - 2\left(\frac13\right)^n u(n) }
$$
...
$$
X(e^{j\omega}) = \frac1{1-\frac34e^{-j\omega}}.
$$
...
$$
H(e^{j\omega}) = \frac{\frac12e^{-j\omega}} {1-\frac12e^{-j\omega}}.
$$
...
$$
\frac1{1-ae^{-j\omega}} \leftrightarrow a^nu(n).
$$
...
$$
\boxed{ H(e^{j\omega}) = \frac{Y(e^{j\omega})} {X(e^{j\omega})} }
$$
...
$$
\boxed{ H(e^{j\omega})=\mathcal F\{h(n)\} }
$$
...
$$
= e^{j\omega n} \sum_kh(k)e^{-j\omega k}.
$$
...
$$
y(n) = |H(e^{j\omega})| e^{j[\omega n+\theta(\omega)]}.
$$
...
$$
H(e^{j\omega}) = \frac{ 1+3e^{-j\omega}+e^{-j2\omega} }{ 1-\frac13e^{-j\omega} +\frac16e^{-j2\omega} }.
$$
...
$$
Y(e^{j\omega}) \left( 1-\frac13e^{-j\omega} +\frac16e^{-j2\omega} \right) = X(e^{j\omega}) \left( 1+3e^{-j\omega}+e^{-j2\omega} \right).
$$

Taking inverse DTFT term by term,

$$
\boxed{ y(n) -\frac13y(n-1) +\frac16y(n-2) = x(n)+3x(n-1)+x(n-2) }
$$
...
$$
Y(e^{j\omega}) \left[ 1-ae^{-j\omega}-be^{-j2\omega} \right] = X(e^{j\omega}) \left[ 1+ce^{-j\omega} \right].
$$

Therefore,

$$
\boxed{ H(e^{j\omega}) = \frac{ 1+ce^{-j\omega} }{ 1-ae^{-j\omega}-be^{-j2\omega} } }
$$
...
$$
H(e^{j\omega}) = \frac{1-4e^{-j\omega}} {1-5e^{-j\omega}}.
$$
...
$$
H(e^{j\omega}) = \frac{ (1-4\cos\omega)+j4\sin\omega }{ (1-5\cos\omega)+j5\sin\omega }.
$$

The magnitude is

$$
\boxed{ |H(e^{j\omega})| = \frac{ \sqrt{(1-4\cos\omega)^2+(4\sin\omega)^2} }{ \sqrt{(1-5\cos\omega)^2+(5\sin\omega)^2} } }
$$

and the phase is obtained from numerator phase minus denominator phase:

$$
\boxed{ \theta(\omega) = \tan^{-1} \frac{4\sin\omega}{1-4\cos\omega} - \tan^{-1} \frac{5\sin\omega}{1-5\cos\omega} }
$$
...
$$
Y(e^{j\omega}) = X(e^{j\omega}) \left[ 1+2e^{-j\omega}+e^{-j2\omega} \right].
$$

Hence

$$
\boxed{ H(e^{j\omega}) = 1+2e^{-j\omega}+e^{-j2\omega} }
$$

Factor:

$$
H(e^{j\omega}) = e^{-j\omega} \left( e^{j\omega}+2+e^{-j\omega} \right).
$$
...
$$
H(e^{j\omega}) = 2e^{-j\omega}(1+\cos\omega).
$$

Therefore,

$$
\boxed{ |H(e^{j\omega})| = 2|1+\cos\omega| }
$$

and, in the range where $1+\cos\omega\ge0$,

$$
\boxed{ \theta(\omega)=-\omega }
$$
...
$$
h(n)= \begin{cases} 1,&0\le n\le N-1,\\ 0,&\text{otherwise}, \end{cases}
$$

the frequency response is

$$
H(e^{j\omega}) = \sum_{n=0}^{N-1}e^{-j\omega n}.
$$

Using the finite geometric-series result,

$$
\boxed{ H(e^{j\omega}) = \frac{1-e^{-jN\omega}} {1-e^{-j\omega}} }
$$

Multiply numerator and denominator by suitable exponential factors:

$$
H(e^{j\omega}) = e^{-j(N-1)\omega/2} \frac{ \sin(N\omega/2) }{ \sin(\omega/2) }.
$$

Hence

$$
\boxed{ |H(e^{j\omega})| = \left| \frac{\sin(N\omega/2)} {\sin(\omega/2)} \right| }
$$

and the linear phase factor contributes

$$
\boxed{ \theta(\omega) = -\frac{(N-1)\omega}{2} }
$$
...
$$
H(e^{j\omega}) = \frac1{1-0.6e^{-j\omega}}.
$$

Multiply numerator and denominator by the complex conjugate:

$$
H(e^{j\omega}) = \frac{ 1-0.6e^{j\omega} }{ (1-0.6e^{-j\omega})(1-0.6e^{j\omega}) }.
$$
...
$$
1-1.2\cos\omega+0.36 = 1.36-1.2\cos\omega.
$$

Therefore,

$$
\boxed{ H(e^{j\omega}) = \frac{ 1-0.6\cos\omega-j0.6\sin\omega }{ 1.36-1.2\cos\omega } }
$$

Thus

$$
H_R(\omega) = \frac{1-0.6\cos\omega} {1.36-1.2\cos\omega}
$$

and

$$
H_I(\omega) = \frac{-0.6\sin\omega} {1.36-1.2\cos\omega}.
$$

Magnitude:

$$
\boxed{ |H(e^{j\omega})| = \frac1{\sqrt{1.36-1.2\cos\omega}} }
$$

Phase:

$$
\boxed{ \theta(\omega) = \tan^{-1} \left( \frac{-0.6\sin\omega} {1-0.6\cos\omega} \right) }
$$
...
$$
X(e^{j\omega}) = \frac1{1-\frac45e^{-j\omega}}.
$$
...
$$
\boxed{ y(n)-\frac45y(n-1) = \frac45x(n) }
$$
...
$$
H(e^{j\omega}) = \begin{cases} 1,&|\omega|\le\omega_c,\\ 0,&\text{otherwise}. \end{cases}
$$

Then

$$
h(n) = \frac1{2\pi} \int_{-\omega_c}^{\omega_c} e^{j\omega n}\,d\omega.
$$

For $n\ne0$,

$$
h(n) = \frac1{2\pi} \left[ \frac{e^{j\omega n}}{jn} \right]_{-\omega_c}^{\omega_c}
$$
...
$$
\boxed{ h(n)=\frac{\sin(\omega_c n)}{\pi n}, \qquad n\ne0 }
$$

At $n=0$, use the limiting value:

$$
\boxed{ h(0)=\frac{\omega_c}{\pi} }
$$

So the complete form is

$$
\boxed{ h(n)= \begin{cases} \dfrac{\sin(\omega_c n)}{\pi n}, &n\ne0,\\[6pt] \dfrac{\omega_c}{\pi}, &n=0. \end{cases} }
$$
...
$$
h(n) = \frac{1}{2\pi} \left[ \int_{\omega_{c1}}^{\omega_{c2}} e^{j\omega n}\,d\omega + \int_{-\omega_{c2}}^{-\omega_{c1}} e^{j\omega n}\,d\omega \right].
$$

For $n\ne0$,

$$
\boxed{ h(n) = \frac{ \sin(\omega_{c2}n) - \sin(\omega_{c1}n) }{ \pi n } }
$$

The value at $n=0$ is

$$
\boxed{ h(0) = \frac{\omega_{c2}-\omega_{c1}}{\pi} }
$$
...
$$
\boxed{ x(n) = \frac1{2\pi} \int_{-\pi}^{\pi} X(e^{j\omega})e^{j\omega n}\,d\omega }
$$
...
$$
\boxed{ \sum_n|x(n)|^2 = \frac1{2\pi} \int_{-\pi}^{\pi} |X(e^{j\omega})|^2\,d\omega }
$$
...
$$
\boxed{ \frac1{2\pi} \int_{-\pi}^{\pi} X(e^{j\omega})e^{j\omega n}\,d\omega }
$$
...
$$
\boxed{ \frac1{1-e^{-j\omega}} }
$$

### 11. FT of $a^nu(n)$

$$
\boxed{ \frac1{1-ae^{-j\omega}} }
$$
...
$$
\boxed{ x(n-m)\leftrightarrow e^{-j\omega m}X(e^{j\omega}) }
$$
...
$$
e^{j2\omega}-e^{-j2\omega} = \boxed{2j\sin(2\omega)}
$$
...
$$
\boxed{ H(e^{j\omega}) = \sum_nh(n)e^{-j\omega n} }
$$
...
$$
x_1\ast x_2 \leftrightarrow X_1X_2
$$

## Derivation 6 — Frequency convolution

$$
x_1x_2 \leftrightarrow \frac1{2\pi}X_1\ast _{\rm periodic}X_2
$$

## Derivation 7 — Modulation

$$
x(n)\cos\omega_0n \leftrightarrow \frac12[X(\omega-\omega_0)+X(\omega+\omega_0)]
$$

## Derivation 8 — Parseval

$$
\sum_n|x(n)|^2 = \frac1{2\pi} \int_{-\pi}^{\pi}|X(e^{j\omega})|^2d\omega
$$
...
$$
\boxed{ X(e^{j\omega}) = \sum_nx(n)e^{-j\omega n} }
$$
...
$$
a^nu(n) \leftrightarrow \frac1{1-ae^{-j\omega}}.
$$
...
$$
\boxed{ e^{-j\omega k} \longleftrightarrow \text{delay by }k }
$$
...
$$
\boxed{ |H|=\sqrt{H_R^2+H_I^2} }
$$

Phase:

$$
\boxed{ \angle H = \tan^{-1}\left(\frac{H_I}{H_R}\right) }
$$
...
$$
\boxed{ x(n)e^{j\omega_0n} \leftrightarrow X(e^{j(\omega-\omega_0)}) }
$$

## Reversal

$$
\boxed{ x(-n)\leftrightarrow X(e^{-j\omega}) }
$$

## Differentiation

$$
\boxed{ nx(n)\leftrightarrow j\frac{dX}{d\omega} }
$$
...
$$
\boxed{ x_1x_2 \leftrightarrow \frac1{2\pi}X_1\ast _{\rm periodic}X_2 }
$$

## Correlation

$$
\boxed{ R_{x_1x_2} \leftrightarrow X_1(e^{j\omega})X_2(e^{-j\omega}) }
$$

## Modulation

$$
\boxed{ x(n)\cos\omega_0n \leftrightarrow \frac12[X(\omega-\omega_0)+X(\omega+\omega_0)] }
$$

## Parseval

$$
\boxed{ \sum_n|x(n)|^2 = \frac1{2\pi} \int_{-\pi}^{\pi}|X(e^{j\omega})|^2d\omega }
$$
...
$$
\boxed{ \delta(n)\leftrightarrow1 }
$$

$$
\boxed{ \delta(n-m)\leftrightarrow e^{-j\omega m} }
$$

$$
\boxed{ a^nu(n) \leftrightarrow \frac1{1-ae^{-j\omega}} }
$$

$$
\boxed{ a^{|n|} \leftrightarrow \frac{1-a^2} {1-2a\cos\omega+a^2}, \qquad |a|<1 }
$$

$$
\boxed{ \left(\frac12\right)^nu(n) \leftrightarrow \frac1{1-\frac12e^{-j\omega}} }
$$

$$
\boxed{ \left(\frac13\right)^nu(n) \leftrightarrow \frac1{1-\frac13e^{-j\omega}} }
$$
...
$$
x(n-m) \rightarrow e^{-j\omega m}X(e^{j\omega}).
$$

Frequency shift:

$$
x(n)e^{j\omega_0n} \rightarrow X(e^{j(\omega-\omega_0)}).
$$
...
$$
\boxed{ \text{time convolution}\rightarrow\text{frequency multiplication} }
$$

but

$$
\boxed{ \text{time multiplication}\rightarrow\text{frequency convolution} }
$$
...
$$
\boxed{ H(e^{j\omega}) \text{ is evaluated over a frequency vector} }
$$
...
$$
\boxed{ \text{DTFT} \quad\Longrightarrow\quad \text{time-domain convolution becomes frequency-domain multiplication} }
$$
