...
$$
\boxed{ \text{complex multiplications}=N^2 }
$$

and

$$
\boxed{ \text{complex additions}=N(N-1). }
$$
...
$$
\boxed{ N\text{-point DFT} \rightarrow \text{smaller DFTs} \rightarrow \text{still smaller DFTs} \rightarrow \text{2-point DFTs} }
$$
...
$$
\boxed{ X_R(k)= \sum_{n=0}^{N-1} \left[ x_R(n)\cos\frac{2\pi nk}{N} + x_I(n)\sin\frac{2\pi nk}{N} \right]. }
$$

The imaginary part is

$$
\boxed{ X_I(k)= \sum_{n=0}^{N-1} \left[ x_I(n)\cos\frac{2\pi nk}{N} - x_R(n)\sin\frac{2\pi nk}{N} \right]. }
$$
...
$$
\boxed{ N^2\text{ complex multiplications} }
$$

$$
\boxed{ N(N-1)\text{ complex additions} }
$$

The textbook also gives the corresponding real-operation counts as

$$
\boxed{ 4N^2\text{ real multiplications} }
$$

and

$$
\boxed{ 4N(N-1)\text{ real additions} }
$$
...
$$
\boxed{ X(k)= F_1(k)+W_N^kF_2(k) }
$$

where

$$
\boxed{ F_1(k)= \sum_{r=0}^{N/2-1} x(2r)W_{N/2}^{rk} }
$$

and

$$
\boxed{ F_2(k)= \sum_{r=0}^{N/2-1} x(2r+1)W_{N/2}^{rk}. }
$$
...
$$
\boxed{ X(k)= F_1(k)+W_N^kF_2(k), \qquad 0\le k<N/2 }
$$

and

$$
\boxed{ X(k+N/2)= F_1(k)-W_N^kF_2(k). }
$$
...
$$
\boxed{ \begin{aligned} A&=a+W_N^kb,\\ B&=a-W_N^kb. \end{aligned} }
$$
...
$$
\boxed{ \text{stages}=\log_2N }
$$

and each stage has

$$
\boxed{ N/2\text{ butterflies}. }
$$
...
$$
\boxed{ \text{complex multiplications} = \frac{N}{2}\log_2N }
$$

and

$$
\boxed{ \text{complex additions} = N\log_2N. }
$$
...
$$
\begin{array}{c|c|c} \text{Normal index}&\text{Binary}&\text{Bit-reversed index}\\ \hline 0&000&000\\ 1&001&100\\ 2&010&010\\ 3&011&110\\ 4&100&001\\ 5&101&101\\ 6&110&011\\ 7&111&111 \end{array}
$$

Therefore the input order becomes

$$
\boxed{ \{x(0),x(4),x(2),x(6),x(1),x(5),x(3),x(7)\}. }
$$
...
$$
\boxed{ 4\text{ butterflies per stage}. }
$$
...
$$
\boxed{ F_1(k) = G_{11}(k)+W_4^kG_{12}(k) }
$$

and similarly,

$$
\boxed{ F_2(k) = G_{21}(k)+W_4^kG_{22}(k). }
$$
...
$$
\boxed{ X(k)= \sum_{n=0}^{N/2-1} \left[ x(n)+x(n+N/2) \right] W_N^{nk} }
$$
...
$$
\boxed{ X(k+N/2)= \sum_{n=0}^{N/2-1} \left[ x(n)-x(n+N/2) \right] W_N^{nk} }
$$
...
$$
\boxed{ \begin{aligned} A&=a+b,\\ B&=(a-b)W_N^k. \end{aligned} }
$$
...
$$
\boxed{ \text{DIT: bit-reversed input, normal output} }
$$

$$
\boxed{ \text{DIF: normal input, bit-reversed output} }
$$
...
$$
\boxed{ x_r(n)= \{x(0),x(4),x(2),x(6),x(1),x(5),x(3),x(7)\}. }
$$
...
$$
\boxed{ \text{normal order} }
$$

Output:

$$
\boxed{ \text{bit-reversed order}. }
$$
...
$$
\boxed{ \begin{aligned} \{& x(0),x(8),x(4),x(12),\\ &x(2),x(10),x(6),x(14),\\ &x(1),x(9),x(5),x(13),\\ &x(3),x(11),x(7),x(15) \}. \end{aligned} }
$$

Number of complex multiplications:

$$
\boxed{ \frac{16}{2}\log_2 16 = 8(4) = 32. }
$$
...
$$
\boxed{ \frac{32}{2}\log_232 = 16(5) = 80. }
$$

Complex additions:

$$
\boxed{ 32\log_232 = 160. }
$$
...
2. Compute the $N$-point DFT of $X^\ast (k)$ using FFT.
...
$$
\boxed{ x(n) = \frac1N \left[ \operatorname{DFT}\{X^\ast (k)\} \right]^\ast . }
$$
...
$$
\boxed{ |X(k)|= \{10,\;2.828,\;2,\;2.828\}. }
$$

### Phase

$$
\boxed{ \angle X(k)= \{0,\;135^\circ,\;0,\;-135^\circ\} }
$$
...
$$
\boxed{ X_1(k)=\{4,-1-j,2,-1+j\} }
$$

and

$$
\boxed{ X_2(k)=\{6,-1-j,0,-1+j\}. }
$$
...
$$
x(n)= \begin{cases} 1,&0\le n<N/2,\\ -1,&N/2\le n<N, \end{cases}
$$
...
$$
\boxed{ y(n)=\operatorname{IDFT}\{Y(k)\}. }
$$
...
$$
X(k)= \{1.5,1-j0.5,0.5,1+j0.5\}
$$

and

$$
H(k)= \{1.5,0.5-j1,-0.5,0.5+j1\}.
$$
...
$$
\boxed{ \begin{aligned} X(k)=\{& 12,\, -1-j2.414,\, 0,\, -1-j0.414,\\ &0,\, -1+j0.414,\, 0,\, -1+j2.414 \}. \end{aligned} }
$$
...
$$
\boxed{ \{12,\;2.61,\;0,\;1.08,\;0,\;1.08,\;0,\;2.61\}. }
$$
...
$$
\boxed{ |X(k)|= \sqrt{X_R^2(k)+X_I^2(k)}. }
$$

Phase is

$$
\boxed{ \angle X(k) = \tan^{-1} \left( \frac{X_I(k)}{X_R(k)} \right) }
$$
...
$$
\boxed{ \{1,4,3,2,2,3,4,1\}. }
$$

The textbook obtains

$$
\boxed{ \begin{aligned} X(k)=\{& 20,\, 5.828-j2.414,\, 0,\, 0.172-j0.414,\\ &0,\, 0.172+j0.414,\, 0,\, 5.828+j2.414 \}. \end{aligned} }
$$
...
$$
\boxed{ \{0,4,2,6,1,5,3,7\}. }
$$

The textbook obtains

$$
\boxed{ \begin{aligned} X(k)=\{& 28,\, -4+j9.656,\, -4+j4,\, -4+j1.656,\\ &-4,\, -4-j1.656,\, -4-j4,\, -4-j9.656 \}. \end{aligned} }
$$
...
$$
\boxed{ X(k)= \{4,-1-j2.414,0,-1-j0.414,0,-1+j0.414,0,-1+j2.414\}. }
$$

Procedure:

1. Find $X^\ast (k)$.
2. Apply 8-point DIF FFT to $X^\ast (k)$.
3. Obtain $8x^\ast (n)$ in the DIF output order.
...
$$
\boxed{ \begin{aligned} X(k)=\{& 7,\, -0.707-j0.707,\, 0,\, -0.707+j0.707,\\ &-1,\, -0.707-j0.707,\, 0,\, -0.707+j0.707 \}. \end{aligned} }
$$
...
Arrange $X^\ast (k)$ in bit-reversed order for DIT.
...
$$
\boxed{ X(k) = X_1(k) + W_9^kX_2(k) + W_9^{2k}X_3(k). }
$$

The three subsequences are formed from samples separated by three indices:

$$
X_1(k): \quad x(0),x(3),x(6)
$$

$$
X_2(k): \quad x(1),x(4),x(7)
$$

$$
X_3(k): \quad x(2),x(5),x(8).
$$
...
$$
\boxed{ X(k)= \{9,\,-1+j1.732,\,0,\,-1,\,0,\,-1-j1.732\}. }
$$
...
$$
\boxed{ \text{DIF = decimation of frequency components}. }
$$
...
$$
\boxed{ \{x(0),x(4),x(8),x(12)\} }
$$

$$
\boxed{ \{x(1),x(5),x(9),x(13)\} }
$$

$$
\boxed{ \{x(2),x(6),x(10),x(14)\} }
$$

$$
\boxed{ \{x(3),x(7),x(11),x(15)\}. }
$$
...
$$
\frac{64}{2}\log_264 = 32(6) = \boxed{192}
$$
...
$$
\frac{256}{2}\log_2256 = 128(8) = 1024.
$$

Percentage saving:

$$
\begin{aligned} \%S_M &= \frac{65536-1024}{65536}\times100\\ &=\boxed{98.43\%}. \end{aligned}
$$
...
$$
\begin{aligned} \%S_A &= \frac{65280-2048}{65280}\times100\\ &=\boxed{96.86\%}. \end{aligned}
$$
...
$$
\boxed{ x \rightarrow \text{FFT} \rightarrow X }
$$

$$
\boxed{ h \rightarrow \text{FFT} \rightarrow H }
$$
...
$$
\boxed{ x(n)= \frac1N \left[ \operatorname{FFT}\{X^\ast (k)\} \right]^\ast . }
$$
...
$$
\boxed{ \text{Time is Decimated} }
$$

and

$$
\boxed{ \text{Input Bit-reversed}. }
$$
...
$$
\boxed{ \text{Frequency is Decimated} }
$$

and

$$
\boxed{ \text{Output Bit-reversed}. }
$$
...
$$
W_8^1=e^{-j\pi/4} = \frac{1}{\sqrt2}(1-j)
$$
...
$$
\boxed{ y=\operatorname{IFFT} \left[ \operatorname{FFT}(x)\operatorname{FFT}(h) \right] }
$$
...
$$
\boxed{ B_{\text{stage}}=\frac N2. }
$$

### Total radix-2 butterflies

$$
\boxed{ B_{\text{total}} = \frac N2\log_2N. }
$$
...
| 14 | $x(n)=\frac1N[\operatorname{DFT}\{X^\ast (k)\}]^\ast $ |
...
$$
\frac{256}{2}\log_2256 = \boxed{1024}.
$$

### 7. 256-point FFT additions

$$
256\log_2256 = \boxed{2048}.
$$
...
$$
\boxed{ \text{twiddle multiplication before add/subtract}. }
$$

### DIF butterfly

$$
\boxed{ \text{twiddle multiplication after add/subtract}. }
$$
...
$$
x(n)=\{1,0,2\}, \qquad h(n)=\{1,1\}
$$

### (b)

$$
x(n)=\{1,2,3\}, \qquad h(n)=\{1,-1\}
$$

### (c)

$$
x(n)=\{1,2,1,2,1\}, \qquad h(n)=\{1,-1,1,1\}
$$

### (d)

$$
x(n)=\{1,2,1,1,1\}, \qquad h(n)=\{1,0,1,0\}.
$$
...
$$
\boxed{ x(n)= \frac1N [\operatorname{DFT}\{X^\ast (k)\}]^\ast . }
$$
...
$$
\boxed{ \text{conjugate} \rightarrow \text{FFT} \rightarrow \text{conjugate} \rightarrow \frac1N. }
$$
...
$$
\boxed{ X=\operatorname{FFT}(x) }
$$

$$
\boxed{ H=\operatorname{FFT}(h) }
$$
...
$$
\boxed{ \text{An efficient algorithm for computing the DFT.} }
$$

### Fundamental principle?

$$
\boxed{ \text{Decompose a large DFT into smaller DFTs.} }
$$

### Why faster?

$$
\boxed{ \text{Uses symmetry and periodicity of }W_N. }
$$

### DIT?

$$
\boxed{ \text{Decimation in time}. }
$$

### DIF?

$$
\boxed{ \text{Decimation in frequency}. }
$$

### DIT input/output?

$$
\boxed{ \text{bit reversed}\rightarrow\text{normal}. }
$$

### DIF input/output?

$$
\boxed{ \text{normal}\rightarrow\text{bit reversed}. }
$$
...
$$
\boxed{ A=a+bW_N^k,\quad B=a-bW_N^k. }
$$

### DIF butterfly?

$$
\boxed{ A=a+b,\quad B=(a-b)W_N^k. }
$$

### IDFT through FFT?

$$
\boxed{ x(n)= \frac1N [\operatorname{FFT}\{X^\ast (k)\}]^\ast . }
$$
...
$$
\boxed{ \text{butterflies/stage}=N/2 }
$$

$$
\boxed{ M_{\text{FFT}}=(N/2)\log_2N }
$$

$$
\boxed{ A_{\text{FFT}}=N\log_2N }
$$

$$
\boxed{ \text{DIT: bit-reversed input} }
$$

$$
\boxed{ \text{DIT: normal output} }
$$

$$
\boxed{ \text{DIF: normal input} }
$$

$$
\boxed{ \text{DIF: bit-reversed output} }
$$

$$
\boxed{ \text{DIT: multiply then add/subtract} }
$$

$$
\boxed{ \text{DIF: add/subtract then multiply} }
$$

$$
\boxed{ A_{\rm DIT}=a+bW_N^k }
$$

$$
\boxed{ B_{\rm DIT}=a-bW_N^k }
$$
...
$$
\boxed{ N_{\rm linear}\ge L_x+L_h-1 }
$$

$$
\boxed{ \text{FFT: }O(N\log_2N) }
$$

$$
\boxed{ \text{Direct DFT: }O(N^2) }
$$
...
$$
\boxed{ \text{Efficient algorithm for DFT computation using divide-and-conquer.} }
$$
...
$$
\boxed{ \text{DIT}\Rightarrow\text{time decimation} }
$$

$$
\boxed{ \text{DIF}\Rightarrow\text{frequency decimation} }
$$
...
$$
\boxed{ bW_N^k\rightarrow a\pm bW_N^k. }
$$

DIF:

$$
\boxed{ a\pm b\rightarrow(a-b)W_N^k. }
$$

### Question: “How to calculate IDFT with FFT?”

$$
\boxed{ X^\ast \rightarrow FFT\rightarrow(\cdot)^\ast \rightarrow1/N. }
$$
...
$$
\boxed{ FFT(x)\times FFT(h)\rightarrow IFFT. }
$$
