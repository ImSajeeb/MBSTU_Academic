...
| "Verify a DTFT property" (shift, modulation, reversal, convolution) | §7.3 |
| "Verify the periodicity property of DTFT" | §7.4 |
...
| "Perform linear/circular convolution using FFT" | §10.3 |
| "Find periodic even/odd parts of a sequence via DFT" | §10.4 |
...
| # | Title | Guide section |
|---|---|---|
| 5.1 | Fourier Transform and Inverse Fourier Transform of a Sequence | §8.1 |
| 5.2 | Fourier Transform of u(t+0.5)−u(t−0.5) | §8.2 |
| 5.3 | Evaluation and Plotting of DTFT of the Transfer Function | §7.1 |
| 5.4 | Time Shifting Property of DTFT | §7.3 |
| 5.5 | Frequency Shifting Property of DTFT | §7.3 |
| 5.6 | Time Convolution Property of DTFT | §7.3 |
| 5.7 | Time Reversal Property of DTFT | §7.3 |
| 5.8 | Frequency Response of the Given System | §7.1 |
| 5.9 | Periodicity Property of DTFT | §7.4 |

### Chapter 6 — Fourier Series and DFT
| # | Title | Guide section |
|---|---|---|
| 6.1 | Fourier Series Representation of a Train of Pulses | §9.1 |
| 6.2 | Fourier Series Representation of a Full Wave Rectified Wave | §9.1 |
| 6.3 | Direct Computation of DFT (Matrix Formulation) | §10.1 |
| 6.4 | Linear Convolution Using DFT | §10.3 |
| 6.5 | Circular Convolution Using DFT | §10.3 |
| 6.6 | Relation Between DFTs of Periodic Even and Odd Parts | §10.4 |
| 6.7 | Parseval's Relation of DFT | §10.5 |
| 6.8 | Circular Time Shifting Property of DFT | §10.6 |
| 6.9 | Gibbs Phenomenon | §9.2 |

### Chapter 7 — FFT
| # | Title | Guide section |
|---|---|---|
| 7.1 | Calculation of the DFT of a Sequence Using FFT | §10.2 |
| 7.2 | Linear Convolution Using FFT | §10.3 |
| 7.3 | Circular Convolution Using FFT | §10.3 |
| 7.4 | Plotting of DFT of Sinusoidal Wave | §10.7 |
...
Also a supporting example (used later inside §7.4's periodicity demonstration), not its own book problem — worth knowing in isolation.
```matlab
n = 1:10;
...
General-purpose distinction, used as a building block by §7.3's property checks.
```matlab
...
### 7.3 DTFT property checks (verify by comparing plots/values)
...
### 7.4 Periodicity property of DTFT
...
### 10.3 Linear & Circular convolution via FFT — same technique as §4.3/§4.4
